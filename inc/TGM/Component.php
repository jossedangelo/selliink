	...
	function socialv_sp_register_required_plugins()
	{
		...
		$plugins = array(
			...
			array(
				...
				'slug'      => 'bbpress',
				'source'     => esc_url('http://assets.iqonic.design/wp/plugins/socialv/bbpress.zip'),
				'required'  => false,
				'desc'     => '',
				'type'      => 'bbpress',
			),
			...
			array(
				...
				'source'     => esc_url('https://assets.iqonic.design/wp/plugins/socialv/bp-verified-member.zip'),
				'required'  => false,
				'desc'     => '',
				'type'      => 'other'
			),
			...
			array(
				...
				'slug'      => 'wc4bp',
				'source'     => esc_url('http://assets.iqonic.design/wp/plugins/socialv/wc4bp.zip'),
				'required'  => false,
				'desc'     => '',
				'type'      => 'woocommerce'
			),
