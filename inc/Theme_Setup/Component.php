	...
	function socialv_setup_wizard_config()
	{
		...
		$wizard = new Merlin(
			...
			$strings = array(
				...
				'welcome%s'                => esc_html__('Social Network and Community BuddyPress Theme' ,'socialv'),
				'welcome-success%s'        => esc_html__('Social Network and Community BuddyPress Theme' , 'socialv'),
