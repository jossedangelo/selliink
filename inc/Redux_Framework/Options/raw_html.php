<?php $theme_setup_page = admin_url("themes.php?page=socialv-setup"); ?>
...
<div class="dashboard-main-wrap">
    <div class="dashboard-main">
        ...
        <a href="<?php echo esc_url("https://socialv-wordpress.iqonic.design/"); ?>" target="_blank" class="redux-btn"><?php esc_html_e('Live Demo','socialv'); ?></a>
    </div>
