...
$label = ! empty( $args['product_name'] ) ? sprintf( esc_html__( '%s quantity', 'socialv' ), wp_strip_all_tags( $args['product_name'] ) ) : esc_html__( 'Quantity', 'socialv' );
...
<div class="quantity">
	...
	<input
		...
		title="<?php echo esc_attr_x( 'Qty', 'Product quantity input tooltip', 'socialv' ); ?>"
		size="4"
